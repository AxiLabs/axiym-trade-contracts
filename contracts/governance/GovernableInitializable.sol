...
abstract contract GovernableInitializable is IErrors, Initializable {
    // --- State Variables ---
    address internal _governance;

    /// @notice Initializes the governance contract address
    /// @param governance_ Address of the deployed governance contract
    function _initializeGovernable(address governance_) internal onlyInitializing {
